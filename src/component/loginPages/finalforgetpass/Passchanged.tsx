...
function Passchanged() {
  return (
          <div className='col-8 p-4' style={{ width: 'fit-content', border:"1px solid black", borderRadius:"20px", display:"flex", justifyContent:"center", textAlign:'center' }}>
            <form>
              ...
              <p className='subheading'>
                ...
                <div className="d-grid">
                  <button type="button" className="btn btn-success btn-block button">Back to Login</button>
                </div>
              </div>
            </form>
          </div>
